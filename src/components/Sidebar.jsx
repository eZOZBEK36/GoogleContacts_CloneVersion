					...
					<div className="sidebar__list">
						<div className="sidebar__contactslist contactslist">
							<ul className="contactslist__item">
								<li>
									<CustomLink divClassName="_router-link" linkActiveClassName="active-route-link" to="/contacts">
										<span>
											<svg width="20" height="20" viewBox="0 0 24 24">
												<path d="M0 0h24v24H0V0z" fill="none"></path>
												<path fill="#5f6368" d="M12 6c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2m0 9c2.7 0 5.8 1.29 6 2v1H6v-.99c.2-.72 3.3-2.01 6-2.01m0-11C9.79 4 8 5.79 8 8s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm0 9c-2.67 0-8 1.34-8 4v3h16v-3c0-2.66-5.33-4-8-4z"></path>
											</svg>
										</span>
										<span>Контакты</span>
									...
									<CustomLink divClassName="_router-link" linkActiveClassName="active-route-link" to="/frequent">
										<span>
											<svg width="20" height="20" viewBox="0 0 24 24">
												...
												<path fill="#5f6368" d="M13 3c-4.97 0-9 4.03-9 9H1l4 3.99L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.25 2.52.77-1.28-3.52-2.09V8z"></path>
											</svg>
										</span>
								...
								<li>
									<CustomLink divClassName="_router-link" linkActiveClassName="active-route-link" to="/suggestions">
										<span>
											<svg width="20" height="20" viewBox="0 0 24 24">
												<path fill="none" d="M0 0h24v24H0V0z"></path>
												<path fill="#5f6368" d="M19 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h4l3 3 3-3h4c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 16h-4.83l-.59.59L12 20.17l-1.59-1.59-.58-.58H5V4h14v14zm-7-1l1.88-4.12L18 11l-4.12-1.88L12 5l-1.88 4.12L6 11l4.12 1.88z"></path>
											</svg>
										</span>
